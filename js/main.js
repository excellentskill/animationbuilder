...
var CMainClass = function()
{
	...
	$('#btn_start').click(function()
	{
		...
		main.animView.show();
		$('.section_data').css('height', height - 60);
		$('.section_data').css('width', width - 59);
		...
		html2canvas(main.animView, {
			onrendered: function(canvas) {
				...
				{
					backCtx.drawImage(image, 0, 0, image.width, image.height, left * rate, top * rate, img_width * rate, img_height * rate);
